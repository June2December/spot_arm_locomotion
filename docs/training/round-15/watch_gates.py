#!/usr/bin/env python3
"""Print the round-15 gate metrics from a live TensorBoard run.

Usage::

    python docs/training/round-15/watch_gates.py [run_dir]
"""
...
GATES = [
    ...
    ("Episode_Reward/leg_joint_deviation", "hip_knee_dev", 1.0),
