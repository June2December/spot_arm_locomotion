#!/usr/bin/env python3
"""Print the round-11 gate metrics from a live TensorBoard run.

Usage::

    python docs/training/round-11/watch_gates.py [run_dir]
"""
